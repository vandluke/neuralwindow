...
static nw_error_t *operation_before(operation_t *operation, operation_type_t operation_type, tensor_t **result)
{
    ...
    case STRUCTURE_OPERATION:
        error = buffer_structure_before(operation->structure_operation->operation_type,
                                        ...
                                        operation->structure_operation->arguments,
...
static nw_error_t *as_operation_forward(tensor_t *x, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    CHECK_NULL_ARGUMENT(x->buffer, "x->buffer");
    CHECK_NULL_ARGUMENT(result, "result");
    ...
    error = buffer_unary(AS_OPERATION, x->buffer, &result->buffer, stream_id);
    if (error)
    {
...
static nw_error_t *unary_operation_forward(unary_operation_t *unary_operation, tensor_t *result, int stream_id)
{
    ...
    case SIGMOID_OPERATION:
        ...
        break;
    case AS_OPERATION:
        error = as_operation_forward(unary_operation->x, result, stream_id);
        break;
    default:
...
static nw_error_t *expand_operation_forward(tensor_t *x, int64_t *shape, int64_t length, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    ...
    error = buffer_structure(EXPAND_OPERATION, x->buffer, shape, length, &result->buffer, stream_id);
    if (error)
    {
...
static nw_error_t *permute_operation_forward(tensor_t *x, int64_t *axis, int64_t length, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    CHECK_NULL_ARGUMENT(axis, "axis");
    CHECK_NULL_ARGUMENT(result, "result");
    ...
    error = buffer_structure(PERMUTE_OPERATION, x->buffer, axis, length, &result->buffer, stream_id);
    if (error)
    {
...
static nw_error_t *reshape_operation_forward(tensor_t *x, int64_t *shape, int64_t rank, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    CHECK_NULL_ARGUMENT(shape, "shape");
    CHECK_NULL_ARGUMENT(result, "result");
    ...
    error = buffer_structure(RESHAPE_OPERATION, x->buffer, shape, rank, &result->buffer, stream_id);
    if (error)
    {
...
static nw_error_t *slice_operation_forward(tensor_t *x, int64_t *arguments, int64_t length, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    ...
    error = buffer_structure(SLICE_OPERATION, x->buffer, arguments, length, &result->buffer, stream_id);
    if (error)
    {
...
static nw_error_t *padding_operation_forward(tensor_t *x, int64_t *arguments, int64_t length, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    CHECK_NULL_ARGUMENT(arguments, "arguments");
    CHECK_NULL_ARGUMENT(result, "result");
    ...
    error = buffer_structure(PADDING_OPERATION, x->buffer, arguments, length, &result->buffer, stream_id);
    if (error)
    {
...
static nw_error_t *image_to_column_operation_forward(tensor_t *x, int64_t *arguments, int64_t length, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    CHECK_NULL_ARGUMENT(arguments, "arguments");
    CHECK_NULL_ARGUMENT(result, "result");
    ...
    error = buffer_structure(IMAGE_TO_COLUMN_OPERATION, x->buffer, arguments, length, &result->buffer, stream_id);
    if (error)
    {
...
static nw_error_t *column_to_image_operation_forward(tensor_t *x, int64_t *arguments, int64_t length, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(x, "x");
    CHECK_NULL_ARGUMENT(arguments, "arguments");
    CHECK_NULL_ARGUMENT(result, "result");
    ...
    error = buffer_structure(COLUMN_TO_IMAGE_OPERATION, x->buffer, arguments, length, &result->buffer, stream_id);
    if (error)
    {
 ...
 */
static nw_error_t *structure_operation_forward(structure_operation_t *structure_operation, tensor_t *result, int stream_id)
{
    ...
    case EXPAND_OPERATION:
        error = expand_operation_forward(structure_operation->x, structure_operation->arguments, structure_operation->length, result, stream_id);
        break;
    case PERMUTE_OPERATION:
        error = permute_operation_forward(structure_operation->x, structure_operation->arguments, structure_operation->length, result, stream_id);
        break;
    case RESHAPE_OPERATION:
        error = reshape_operation_forward(structure_operation->x, structure_operation->arguments, structure_operation->length, result, stream_id);
        break;
    case SLICE_OPERATION:
        error = slice_operation_forward(structure_operation->x, structure_operation->arguments, structure_operation->length, result, stream_id);
        break;
    case PADDING_OPERATION:
        error = padding_operation_forward(structure_operation->x, structure_operation->arguments, structure_operation->length, result, stream_id);
        break;
    case IMAGE_TO_COLUMN_OPERATION:
        error = image_to_column_operation_forward(structure_operation->x, structure_operation->arguments, structure_operation->length, result, stream_id);
        break;
    case COLUMN_TO_IMAGE_OPERATION:
        error = column_to_image_operation_forward(structure_operation->x, structure_operation->arguments, structure_operation->length, result, stream_id);
        break;
    default:
 ...
 *          
 */
static nw_error_t *unary_operation_create(unary_operation_t **unary_operation,
 ...
 */
static nw_error_t *operation_forward(operation_t *operation, operation_type_t operation_type, tensor_t *result, int stream_id)
{
    CHECK_NULL_ARGUMENT(operation, "operation");
    CHECK_NULL_ARGUMENT(result, "result");
    ...
    case REDUCTION_OPERATION:
        ...
        break;
    case STRUCTURE_OPERATION:
        error = structure_operation_forward(operation->structure_operation, result, stream_id);
        break;
    case CREATION_OPERATION:
