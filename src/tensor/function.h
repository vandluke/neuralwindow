...
nw_error_t *binary_operation_create(binary_operation_t **operation, binary_operation_type_t operation_type, const tensor_t *x, const tensor_t *y);
void binary_operation_destroy(binary_operation_t *operation);
nw_error_t *binary_operation_forward(binary_operation_t *operation, tensor_t *result);
